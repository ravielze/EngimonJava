...
public class Battle extends EPage {
    ...
    public void update() {
        ...
        thirdRow.add(EButtonFactory.CreateDefaultFontButton("Proceed Battle", Color.decode("#fcff5e"), new MouseAdapter() {
            @Override
        ...
        thirdRow.add(EButtonFactory.CreateDefaultFontButton("Cancel Battle", Color.decode("#fcff5e"), new MouseAdapter() {
            @Override
            public void mouseClicked(MouseEvent e) {
                EMenu.getInstance().changePage(EMenu.MAIN_PAGE);
            }
